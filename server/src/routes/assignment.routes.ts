...
router.route("/")
     ...
     */
    .post(isClassroomTutor as any, upload.array('attachments', 3), assignmentController.createAssignment as any);
...
router.route("/:assignmentId")
     ...
     */
    .patch(isClassroomTutor as any, assignmentController.updateAssignment as any)
     ...
     */
    .delete(isClassroomTutor as any, assignmentController.deleteAssignment as any);
...
router.route("/:assignmentId/submissions")
     ...
     */
    .get(isClassroomTutor as any, assignmentController.getAssignmentSubmissions as any);
